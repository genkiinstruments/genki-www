          ...
          <dl class="divide-y divide-gray-100">
            ...
            >
              ...
              <dd class="mt-1 text-sm/6 text-gray-700 sm:col-span-2 sm:mt-0">
                <h1 class="text-black font-black">Wave Ring</h1>
                <div>
                ...
                <h1 class="text-black font-black">Ring Strap</h1>
                <div>
                ...
                <h1 class="text-black font-black">Charging Cable</h1>
                <div>
                  micro A (Ring) to USB A (Computer) <br />
                  Length: 12.59 in / 320 mm
                </div>
                <h1 class="text-black font-black">Softcase</h1>
                <div></div>

                <h1 class="text-black font-black">Salesbox</h1>
                <div></div>
              </dd>
            </div>
            <div
