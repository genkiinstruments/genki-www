    ...
    <div class="mx-auto mt-8 max-w-2xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
      <div>
        <div class="px-4 sm:px-0">
          <h3 class="text-base/7 font-semibold text-gray-900">Wave Ring</h3>
          <p class="mt-1 max-w-2xl text-sm/6 text-gray-500">Technical Specifications</p>
        </div>
        <div class="mt-6 border-t border-gray-100">
          <dl class="divide-y divide-gray-100">
            <div class="bg-gray-50 px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-3">
              <dt class="text-sm/6 font-medium text-gray-900">Dimensions</dt>
              <dd class="mt-1 text-sm/6 text-gray-700 sm:col-span-2 sm:mt-0">
                <h1 class="font-black text-black">Wave Ring</h1>
                <div>
                  Height: 1.1 in / 28 mm <br />
                  Width: 0.82 in / 21 mm (widest part) <br />
                  Depth: 0.94 in / 24 mm <br />
                </div>

                <h1 class="font-black text-black">Ring Strap</h1>
                <div>
                  Width: 0.35 in / 9 mm <br />
                  Fits fingers 0.59-1.02 in / 15-26 mm in diameter
                </div>
                -

                <h1 class="font-black text-black">Charging Cable</h1>
                <div>
                  micro A (Ring) to USB A (Computer) <br />
                  Length: 12.59 in / 320 mm
                </div>
                <h1 class="font-black text-black">Softcase</h1>
                <div></div>

                <h1 class="font-black text-black">Salesbox</h1>
                <div></div>
              </dd>
            </div>
            ...
            <div class="bg-gray-50 px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-3">
              ...
              <dd class="mt-1 text-sm/6 text-gray-700 sm:col-span-2 sm:mt-0">
                Fugiat ipsum ipsum deserunt culpa aute sint do nostrud anim incididunt cillum culpa consequat. Excepteur qui ipsum aliquip consequat sint. Sit id mollit nulla mollit nostrud in ea
                officia proident. Irure nostrud pariatur mollit ad adipisicing reprehenderit deserunt qui eu. Foo bar.
              </dd>
            </div>
            <div class="bg-white px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-3">
