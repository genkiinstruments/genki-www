      ...
      <ol role="list" class="flex items-center space-x-4">
        ...
        <li class="text-sm">
          <a
            href="/"
            aria-current="page"
            class="font-medium text-gray-500 hover:text-gray-600">Wave Ring</a
          >
        </li>
      </ol>
    </nav>
        ...
        >
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 lg:grid-rows-3 lg:gap-8">
            <img
              ...
              class="rounded-lg lg:col-span-2 lg:row-span-2 w-full h-full object-cover"
            />
            <img
              src={box}
              alt="Side profile of women&#039;s Basic Tee in black."
              class="hidden rounded-lg lg:block w-full h-full object-cover"
            />
            <img
              src={korg}
        ...
        <div class="mt-8 lg:col-span-5">
          <form>
              ...
              <fieldset aria-label="Choose a color" class="mt-2">
                <div class="flex items-center gap-x-3">
                  ...
                  >
                    ...
                    <span
                      aria-hidden="true"
                      class="size-8 rounded-full border border-black/10 bg-gray-400"
                    ></span>
                  </label>
                </div>
              </fieldset>
            ...
            <div class="mt-8">
              <div class="flex items-center justify-between">
                <h2 class="text-sm font-medium text-gray-900">Quantitiy</h2>
                <a
                  href="/"
                  class="text-sm font-medium text-[#FF5F49] hover:text-[#FF5F49]/80"
                  >See sizing chart</a
              ...
              <fieldset aria-label="Choose a size" class="mt-2">
                <div class="grid grid-cols-3 gap-3 sm:grid-cols-6">
                  <!--
                    ...
                    Active: "ring-2 ring-[#FF5F49]/80 ring-offset-2"
                    Checked: "border-transparent bg-[#FF5F49] text-white hover:bg-[#FF5F49]/80", Not Checked: "border-gray-200 bg-white text-gray-900 hover:bg-gray-50"
                  -->
                  <label
                    class="flex cursor-pointer items-center justify-center rounded-md border px-3 py-3 text-sm font-medium uppercase focus:outline-hidden sm:flex-1"
                  >
                    <input
                      type="radio"
                      name="size-choice"
          ...
          <div class="mt-10">
            ...
            <div class="mt-4 space-y-4 text-sm/6 text-gray-500">
              <p>
                The Wave Ring is an extension of your creativity. This MIDI
                controller can add dynamic effects with the tap of a finger, the
                click of a button, the wave of your hand.
              </p>
              <p>
                Included with your purchase of Wave, Softwave unlocks the full
                functionality of your wearable technology. Customize each and
                every input range, CC value, movement curve, and more for total
          ...
          <div class="mt-8 border-t border-gray-200 pt-8">
            ...
            <div class="mt-4">
              ...
              >
                ...
                <li class="pl-2">
                  Use natural movements to change your sounds.
                </li>
...
<!-- Video Section -->
<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 rounded-md">
  <div class="relative overflow-hidden">
    <!-- 16:9 aspect ratio wrapper -->
    <div class="relative pt-[50%] rounded-2xl object-cover">
      <iframe
        title="Video of Wave being used"
        src="https://player.vimeo.com/video/624358076?background=1&autoplay=1&loop=1&byline=0&title=0"
