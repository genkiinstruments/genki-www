<script>
  ...
  import bergur from "$lib/assets/testimonial_bergur.png";
  import divinci from "$lib/assets/testimonial_divinci.png";
  import mash from "$lib/assets/testimonial_davidmash.png";
  ...
  const testimonials = [
    ...
    },
    {
      ...
      name: "DiVinci",
      quote:
        "I use Wave to get to a deeper flow state quicker and stay there when I'm performing",
      title:
        "Founder member and producer of Orlando-based hip hop group Solillaquists of Sound, and electro-soul duo Chakra Khan.",
    },
    {
      image: mash,
      name: "David Mash",
      quote:
        "There are simply no other gesture controllers on the market that work as well",
      title:
        "Senior vice president for innovation, strategy and technology at Berklee College of Music",
    },
  ];
...
<div class="bg-white pt-24 pb-16 sm:pt-32 sm:pb-24 xl:pb-48">
  <div class="bg-gray-900 pb-48 sm:pb-32">
    ...
    <div class="relative mx-auto max-w-6xl px-6 lg:px-8">
      <div
        class="flex flex-col items-center gap-x-8 gap-y-10 sm:gap-y-8 xl:flex-row xl:items-stretch"
      >
          ...
          <figure class="relative isolate pt-6 sm:pt-12">
            ...
            <div class="relative h-[200px]">
              ...
              {#key currentIndex}
                ...
                >
                  <blockquote
                    class="text-4xl/8 font-semibold text-white sm:text-4xl/9"
                  >
